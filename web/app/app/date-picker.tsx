...
export default function DatePicker({
  ...
  // Ouvre vers le haut si la place manque sous le champ (bas de fiche).
    ...
    <div ref={rootRef} className="relative">
      <button
        ...
        onClick={() => {
          ...
          setEnHaut(!!rect && window.innerHeight - rect.bottom < 380);
          setOpen((v) => !v);
        }}
      ...
      {open && (
        <div
          ...
          className={`absolute left-0 z-30 w-72 rounded-lg border border-hairline bg-white p-3 shadow-card ${
            enHaut ? "bottom-full mb-1.5" : "mt-1.5"
          }`}
        >
